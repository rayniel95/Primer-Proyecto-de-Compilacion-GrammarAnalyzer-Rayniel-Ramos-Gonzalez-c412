from Cp7_test.cmp.pycompiler import Production, Sentence, Symbol, EOF, Epsilon
...
class DisjointSet:
    ...
    @property
    def groups(self):
        return [[n for n in self.nodes.values() if n.representative == r] for r
                in self.representatives]

    def __len__(self):
        return len(self.representatives)

    def __getitem__(self, item) -> 'DisjointNode':
